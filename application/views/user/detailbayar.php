        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?= base_url(); ?>datauser/infobayar/" class="btn btn-primary">Kembali</a>
                    <!-- <a href="<?= base_url(); ?>datauser/print/" title="Print" class="btn btn-dark float-right"><i class="fas fa-fw fa-print"></i>Print</a> -->
                </div>
            </div>
        </div>
    </div>
